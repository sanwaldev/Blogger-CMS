...
echo "<option value='{$username}'>{$username}</option>";
 ...
 ?>
  ...
  <div class="form-group">
    ...
    <img height="80px" src="../images/<?php echo $post_image; ?>" alt="">
  </div>
  ...
  <div class="form-group">
    ...
    <td><a class="btn btn-danger" onClick=\"Javascript: return confirm('Are you sure you want to delete'); \" href='posts.php?delete=<?php echo $post_id ?>'>Delete</a>
  </div>
  <?php

    //DELETE FROM categories table Query
    if(isset($_POST['delete_post'])){
      $the_post_id = $_POST['delete_post'];
